...
export default function PersonCard({
  ...
  return (
    <div
      className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 flex-shrink-0 relative"
      style={{
        width: "500px",
        height: "500px",
        minWidth: "500px",
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 bg-white/95 backdrop-blur-sm">
