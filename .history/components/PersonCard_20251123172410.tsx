              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, rgb(16, 185, 129) 0%, rgb(16, 185, 129) ${(currentTime / duration) * 100}%, rgb(167, 243, 208) ${(currentTime / duration) * 100}%, rgb(167, 243, 208) 100%)`
                    }}
                  />
