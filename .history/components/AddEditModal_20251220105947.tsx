...
interface AddEditModalProps {
  ...
  onShare?: () => void;
  projectName?: string;
  projectTheme?: "birthday" | "christmas" | "neutral";
}
          ...
          <div>
            ...
            {projectName && (
              <div className="mb-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800">
                {`Record a short voice memo wishing ${projectName} a ${
                  projectTheme === "christmas"
                    ? "Merry Christmas"
                    : projectTheme === "birthday"
                    ? "Happy Birthday"
                    : "wonderful day"
                }.`}
              </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            {editCard && onShare && (
              <button
                ...
                className="flex-1 px-6 py-3 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-all font-semibold flex items-center justify-center gap-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
