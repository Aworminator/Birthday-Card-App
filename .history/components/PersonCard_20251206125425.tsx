...
export default function PersonCard({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300" style={{ width: '500px', height: '500px' }}>
      <div className="relative bg-gradient-to-br from-gray-100 to-gray-200" style={{ height: '300px' }}>
        {card.image_url && (
          <Image
            src={card.image_url}
            alt={card.name}
      ...
      <div className="p-5 flex-1 flex flex-col" style={{ height: '200px' }}>
