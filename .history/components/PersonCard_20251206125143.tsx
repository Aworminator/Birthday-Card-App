...
export default function PersonCard({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 w-[500px] h-[500px] flex flex-col">
      <div className="relative h-[300px] bg-gradient-to-br from-gray-100 to-gray-200 flex-shrink-0">
        {card.image_url && (
          <Image
            src={card.image_url}
            alt={card.name}
