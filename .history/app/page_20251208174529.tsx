              ...
              <div className="flex gap-3">
                ...
                {themeMode && (
                  <div className="flex items-center gap-2">
                    <label className="flex items-center gap-2 px-4 py-3 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-all shadow-md hover:shadow-lg font-semibold cursor-pointer">
                      <svg
                        className="w-5 h-5"
                        fill="none"
                        stroke="currentColor"
