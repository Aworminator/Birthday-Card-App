...
export default function SharePage() {
  ...
  // Prepare element properties in case source changes; actual volume controlled via Web Audio
  useEffect(() => {
        ...
        <button
          onClick={async () => {
            ...
            if (isPlaying) {
              ...
              try {
                // Create AudioContext and route through GainNode only on user gesture
                ...
                try { audio.playsInline = true as any; } catch {}
                audio.muted = true;
