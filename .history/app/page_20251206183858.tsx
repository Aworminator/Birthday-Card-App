...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (viewMode && background === "birthday") {
      const balloonContainer = document.getElementById("balloons");
      if (!balloonContainer) return;

      const colors = ["#FF6B6B", "#FFD93D", "#6BC9FF", "#95E1D3", "#F38181"];
      ...
      const interval = setInterval(createBalloon, 500);
