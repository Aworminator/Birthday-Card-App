          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              ...
              <div className="flex flex-wrap gap-2 md:gap-3 w-full md:w-auto">
                ...
                {/* Reordered: Theme, Add, Invite, View, Share */}
                <button
                  onClick={() => setThemeMode(true)}
                  className="flex items-center gap-1 md:gap-2 px-2 md:px-6 py-2 md:py-3 rounded-xl transition-all shadow-md hover:shadow-lg font-semibold text-xs md:text-base bg-gray-100 text-gray-600 hover:bg-gray-200"
                >
                ...
                <button
                  onClick={() => {
                    if (savedTheme === "neutral") {
                      alert("Please select a theme before adding cards.");
                      setThemeMode(true);
                      return;
                    }
                    handleAddClick();
                  }}
                  disabled={savedTheme === "neutral"}
                  className={`flex items-center gap-1 md:gap-2 px-2 md:px-6 py-2 md:py-3 rounded-xl transition-all shadow-md hover:shadow-lg font-semibold text-xs md:text-base ${
                    savedTheme === "neutral"
                ...
                <button
                  ...
                  className="flex items-center gap-1 md:gap-2 px-2 md:px-6 py-2 md:py-3 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-all shadow-md hover:shadow-lg font-semibold text-xs md:text-base"
                >
                  <svg
                    className="w-4 h-4 md:w-5 md:h-5"
                    fill="none"
