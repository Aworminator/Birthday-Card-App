...
export default function ProjectPage() {
  ...
  // Keep background music volume in sync with bgVolume while in view mode
  useEffect(() => {
    if (!viewMode) return;
    ...
    if (!audio.paused) applyVolume();
    return () => {
      audio.removeEventListener("playing", onPlaying);
    };
  }, [viewMode, customMusicUrl, useDefaultMusic, savedTheme, bgVolume]);
