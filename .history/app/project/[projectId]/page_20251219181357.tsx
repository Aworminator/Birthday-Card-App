...
import { playWithReliableVolume } from "@/lib/audioUtils";
              ...
              onClick={async () => {
                ...
                if (isPlaying) {
                  ...
                  try {
                    ...
                    // Use reliable volume start: avoid mute/unmute when using Web Audio
                    await playWithReliableVolume(audio, 0.4, 50, false);
                    setIsPlaying(true);
                  } catch (err) {
